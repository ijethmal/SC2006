          ...
          <div className="main-settings">
            <div className="settings-container">
              ...
              <div className="setting">
                ...
                <div className="account-management-container">
                  <div className="account-details">
                    <div className="account-details-row">
                      <i className="account-management">Account Management</i>
                        ...
                        <div className="personal-info-container">
                          <div className="personal-info-details">
                            ...
                            <div className="name-e-mail">
                              Name | E-mail | personal information
                            </div>
                          </div>
                    ...
                    <div className="location-container">
                      <div className="location-details">
                        <i className="location">Location</i>
                      </div>
                          ...
                          <div className="area-details">
                            ...
                            <div className="dropdown-container">
                              <div className="dropdown-input">
                                <div className="dropdown-input-child" />
                                <div className="dropdown-background" />
                                <div className="dropdown-content">
                                  <b className="dropdown">Dropdown</b>
                            ...
                            <div className="available-interests-details">
                              ...
                              <div className="dropdown-container">
                                <div className="preference-dropdown-input">
                                  <div className="preference-dropdown-input-child" />
                                  <div className="dropdown-preference">
                                    <b className="dropdown">Dropdown</b>
                                    <div className="vector-wrapper">
                                      <img
                                        className="vector-icon"
                ...
                <div className="account-details-row">
                  <i className="notification-settings">Notification Settings</i>
